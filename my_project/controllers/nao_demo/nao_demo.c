...
static double maxRShoulderPitchPosition;
static double minRShoulderPitchPosition;

static double maxRShoulderRollPosition;
static double minRShoulderRollPosition;

static double maxRElbowYawPosition;
static double minRElbowYawPosition;
...
static void find_and_enable_devices() {
  ...
  // gps
  gps = wb_robot_get_device("hand_gps");
  ...
  //
  maxRShoulderPitchPosition=wb_motor_get_max_position(RShoulderPitch);
  minRShoulderPitchPosition=wb_motor_get_min_position(RShoulderPitch);
  printf("Shoulder Pitch max: %f , min: %f \n", maxRShoulderPitchPosition, minRShoulderPitchPosition);
  
  //
  maxRShoulderRollPosition=wb_motor_get_max_position(RShoulderRoll);
  minRShoulderRollPosition=wb_motor_get_min_position(RShoulderRoll);
  printf("Shoulder Roll max: %f , min: %f \n", maxRShoulderRollPosition, minRShoulderRollPosition);
  
  //
  maxRElbowYawPosition=wb_motor_get_max_position(RElbowYaw);
  minRElbowYawPosition=wb_motor_get_min_position(RElbowYaw);
  printf("Elbow Yaw max: %f , min: %f \n", maxRElbowYawPosition, minRElbowYawPosition);
  
  //
  maxRElbowRollPosition=wb_motor_get_max_position(RElbowRoll);
  minRElbowRollPosition=wb_motor_get_min_position(RElbowRoll);
  printf("Elbow Roll max: %f , min: %f \n", maxRElbowRollPosition, minRElbowRollPosition);
...
static void set_arms_angle(double angleShoulderPitch,double angleShoulderRoll, double angleElbowYaw, double angleElbowRoll) {
    double clampedAngleShoulderPitch = angleShoulderPitch;
    if (clampedAngleShoulderPitch > maxRShoulderPitchPosition){
      clampedAngleShoulderPitch = maxRShoulderPitchPosition;
    }else if (clampedAngleShoulderPitch < minRShoulderPitchPosition){
      clampedAngleShoulderPitch = minRShoulderPitchPosition;
      }
      double clampedAngleShoulderRoll = angleShoulderRoll;
    if (clampedAngleShoulderRoll > maxRShoulderRollPosition)
      clampedAngleShoulderRoll = maxRShoulderRollPosition;
    else if (clampedAngleShoulderRoll < minRShoulderRollPosition)
      clampedAngleShoulderRoll = minRShoulderRollPosition;
      
       double clampedAngleElbowYaw = angleElbowYaw;
    if (clampedAngleElbowYaw > maxRElbowYawPosition)
      clampedAngleElbowYaw = maxRElbowYawPosition;
    else if (clampedAngleElbowYaw < minRElbowYawPosition)
      clampedAngleElbowYaw = minRElbowYawPosition;
  
   double clampedAngleElbowRoll = angleElbowRoll;
    if (clampedAngleElbowRoll > maxRElbowRollPosition)
      clampedAngleElbowRoll = maxRElbowRollPosition;
    else if (clampedAngleElbowRoll < minRElbowRollPosition)
      clampedAngleElbowRoll = minRElbowRollPosition;
  
  
  wb_motor_set_position(RShoulderPitch,clampedAngleShoulderPitch);
  wb_motor_set_position(RShoulderRoll,clampedAngleShoulderRoll);
  wb_motor_set_position(RElbowYaw,clampedAngleElbowYaw);
  wb_motor_set_position(RElbowRoll,clampedAngleElbowRoll);
}
